...
const navLinks = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: "Festival Poster Plans", href: "#services" },
      { label: "Other Design Services", href: "#services" },
      { label: "Website Design Packages", href: "#services" },
      { label: "Social Media Management", href: "#services" },
      { label: "Branding & Website Combo Packages", href: "#services" },
    ],
  },
